    ...
    <div id="ContactUs" class="my-2 my-md-3 bg-danger">
        <div class="container">
            <div class="row">
                    ...
                    <div class="bg-info p-3 shadow">
                        ...
                        <div class="">
                            <ul class="list-unstyled">
                                <li class="fs-5"><i class="fa-solid fa-location-dot text-primary"></i> VG-013, First
                                    Floor, Pruksa Silvana,
                                    Budigere Cross, Old Madras Road Bengalore, Karnataka 560049
                                    Landmark:Behind Prestige Tranquility</li>
                                <li class="fs-5 pt-2"><i class="fa-solid fa-phone-volume text-primary"></i> <a
                                        href="tel:09986507655" class="text-decoration-none"> +91 9986507655</a></li>
                                <li class="fs-5 py-2"><i class="fa-brands fa-whatsapp text-primary"></i> <a
                                        href="tel:08048505759" class="text-decoration-none"> Landline:+91 80485
                                        05759</a> </li>
                                <li class="fs-5"><i class="fa-solid fa-envelope text-primary"></i><a
                                        href="mailto:peasad@chekkeraproperties.com" class="text-decoration-none">
                                        prasad@chekkeraproperties.com</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="p-3 mt-3">
                        <form class="" wire:submit.prevent="SaveData">
                            <div class=" mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                @error('subject') <span class="text-success">{{ $message }}</span> @enderror
                            </div>
